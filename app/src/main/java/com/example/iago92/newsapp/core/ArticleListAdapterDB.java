...
public class ArticleListAdapterDB extends RecyclerView.Adapter<ArticleListAdapterDB.ViewHolder> {
    private List<Article> mDataset;
    private Context context;
    private ArticleDB articleDB;

    // Provide a suitable constructor.
    public ArticleListAdapterDB(Context contexts, List<Article> myDataset) {
    ...
    @Override
    public ArticleListAdapterDB.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        ...
        holder.setClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                if (!isLongClick) {
                    ...
                    articleDB.dropNew(mDataset.get(position).getTitle());
                    Toast.makeText(context, "Artículo eliminado de la lista",
